...
public class MessageRepository : BaseRepository, IMessageRepository
{
    ...
    {
        return Execute(@"insert into message(content, sender_id, recipient_id) values(:content,:sender_id,:recipient_id)", messageEntity);
    }
    ...
    {
        return Query<MessageEntity>("select * from messages where recipent_id =: recipient_id", new { recipient_id = recipientId });
    }
